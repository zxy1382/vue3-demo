<template>
  <teleport :to="mergeProps.warpper">
    ...
    >
      <mars-icon
        :icon="mergeProps.thumbnail.icon"
        :width="20"
        color="#FFFFFF"
      ></mars-icon>
    </div>
...
const mergeProps = computed(() => {
  ...
  newProps.thumbnail.icon =
    newProps.thumbnail.icon ?? newProps.icon ?? "left-expand";
...
function initSize() {
  ...
  if (
    ...
    h =
      warpperEle.offsetHeight - mergeProps.value.top - mergeProps.value.bottom;
